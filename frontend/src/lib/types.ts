...
// Keep this file in sync with backend/src/lib/tb/types.ts -- frontend and
// backend are two independent npm projects now, so this is a deliberate
// duplication of the wire contract rather than a shared import.
